...
public class VsWhereAdapter(Process process, CancellationToken token = default) : IVsWhereAdapter
{
    ...
    public async Task<ICollection<string>> GetVisualStudioPathsAsync()
    {
        ...
        {
            throw new EnvironmentConfigurationException("Visual Studio is not installed.");
        }
